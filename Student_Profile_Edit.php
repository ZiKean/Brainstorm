...
if (isset($_SESSION['username'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE students SET FirstName='$firstName', Surname='$surname', Email='$email', DOB='$dob' WHERE Username='$username'";
...
<body>
    ...
    <input type="text" class="inputbox2" name="firstName" value="<?php echo $firstName; ?>" style="top: 418px; left: 80px;">

    <!-- Surname -->
    <div class="inputbox_title" style="top: 392px; left: 582px;">Surname:</div>
    <input type="text" class="inputbox2" name="surname" value="<?php echo $surname; ?>" style="top: 418px; left: 559px;">

    <!-- Email -->
    <div class="inputbox_title" style="top: 504px; left: 104px;">Email address:</div>
    <input type="email" class="inputbox" name="email" value="<?php echo $email; ?>" style="top: 531px; left: 80px;">

    <!-- D.O.B -->
    <div class="inputbox_title" style="top: 617px; left: 104px;">D.O.B:</div>
    <input type="date" class="inputbox" name="dob" value="<?php echo $dob; ?>" style="top: 646px; left: 80px;">
